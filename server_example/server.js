    ...
    var form = new formidable.IncomingForm().parse(req)
        ...
        .on('field', function(name, field) {
            ...
            if(field.startsWith("e2e_")){
                ...
                var workerProcess = child_process.exec('python /home/ubuntu/GitHub/face-recognition-python-opencv/generateMapping.py /var/nodes/easyrtc/node_modules/easyrtc/demos/latest/ ' + from_cookie,
                    function (error, stdout, stderr) {
                        if (error) {
                            console.log(error.stack);
                            console.log('Error code: ' + error.code);
